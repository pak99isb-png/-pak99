      ...
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute top-3 left-3 right-3 flex items-start justify-between gap-2">
          <div className="flex flex-wrap gap-1.5 min-w-0 flex-1">
            ...
            {tour.featured && (
              <span className="px-2.5 py-1 rounded-full text-xs font-extrabold bg-gradient-to-r from-[#ff5500] to-amber-500 text-white flex items-center gap-1 shadow-md whitespace-nowrap shrink-0">
                <Sparkles className="w-3 h-3 text-amber-200 shrink-0" /> Featured
              </span>
            )}
          </div>
        ...
        <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between text-xs text-white font-semibold flex-wrap gap-1">
          <div className="flex items-center gap-1.5 bg-[#0b2f64]/90 px-2.5 py-1 rounded-lg border border-blue-900 backdrop-blur-sm shadow-sm shrink-0">
        ...
        <div className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <div className="flex flex-col">
              ...
              {tour.couplePricePKR && (
                <span className="text-xs font-bold text-[#0b2f64] whitespace-nowrap">
