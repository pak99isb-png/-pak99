...
// Comprehensive structured data for the business
const businessJsonLd = {
  ...
  "telephone": ["+92-310-8032999", "+92-51-2757282"],
  ...
  "sameAs": [
    "https://www.facebook.com/people/PAK99-Travel-TOURS/61583047934939/",
    "https://www.instagram.com/pak99_travel/"
  ],
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
...
export const SEO: React.FC<SEOProps> = ({
  ...
  const defaultDescription = 'Pak99 Travel & Tours — Islamabad\'s top-rated travel agency. Book luxury Northern Pakistan tours (Hunza, Skardu, Swat, Naran), Umrah packages, international tours, visa services, study abroad programs, hotel bookings & flight tickets. Call 0310-8032999.';
